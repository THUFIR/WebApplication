...
public class AuthenticateToken1 implements MyToken {

    private static Logger log = Logger.getLogger(AuthenticateToken1.class.getName());
    private Map<String, MyRoles> mapOfUsers;
    private String duke = "duke..";
    private String login = "nemo";
    private String c = AuthenticateToken1.class.getName();
    private boolean auth = false;
    private String greeting = "";
    private ControllerToken controllerToken = null;

    public AuthenticateToken1() {  //would like to make private
        log.info(AuthenticateToken1.class.getName() + "\tnew..");
    }
